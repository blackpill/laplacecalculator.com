...
export async function generateMetadata({ params }: { params: Params; }): Promise<Metadata> {
  ...
  return {
    title: 'Inverse Laplace Transform Calculator - Free',
    description: 'Fast and accurate Inverse Laplace transform & inverse Laplace transform calculations for engineering and mathematics',
    alternates: {
